...
from jamgpt.common import setup_default_logging
...
def load_model_from_dir(
    tokenizer_path, checkpoints_dir, device, phase, model_tag=None, step=None
):
...
def load_model(tokenizer_path, model_path, source, *args, **kwargs):
    model_dir = {
    ...
    checkpoints_dir = os.path.join(model_path, model_dir)
