...
from jamgpt.common import compute_init, print0, compute_cleanup, autodetect_device_type
from jamgpt.dataloader import tokenizing_distributed_data_loader
from jamgpt.tokenizer import get_token_bytes
...
for split_name in ["train", "val"]:
    loader = tokenizing_distributed_data_loader(
        tokenizer_dir, device_batch_size, sequence_len, split_name, device=device
    )
    with autocast_ctx:
