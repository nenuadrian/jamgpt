...
from jamgpt.common import compute_init, compute_cleanup, print0, autodetect_device_type
from jamgpt.tokenizer import HuggingFaceTokenizer
from jamgpt.checkpoint_manager import load_model
from jamgpt.core_eval import evaluate_task

# -----------------------------------------------------------------------------
# nanoChat specific function dealing with I/O etc.


def evaluate_model(eval_bundle_dir, model, tokenizer, device, max_per_task=-1):
    """
...
def main():
    ...
    centered_results = {}
    if ddp_rank == 0:
        output_csv_path = os.path.join(args.eval_output, f"{model_slug}.csv")
